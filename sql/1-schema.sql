...
CREATE TABLE users (
   ...
   email TEXT NOT NULL UNIQUE
    ...
    -- Stripe customer record with an active creditcard
...
-- after the fact. It can also, for example, be used to drive internal security programs tasked with looking for
-- suspicious activity.
--
...
-- Create an index on idempotency foreign key in rides for fast lookup
